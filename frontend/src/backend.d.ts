...
export interface backendInterface {
    ...
    addPrice(ratePerTonne: number, ratePerKm: number): Promise<bigint>;
    ...
    calculatePrice(weight: number, distance: number, truckType: string): Promise<number>;
    createLoad(load: Load): Promise<string>;
    deleteClient(client: Principal): Promise<void>;
    deleteContactMessage(callerPrincipal: Principal): Promise<void>;
    deleteLoad(loadId: string): Promise<void>;
    deletePrice(priceId: bigint): Promise<void>;
    deleteTransporter(transporter: Principal): Promise<void>;
    ...
    getAllPrices(): Promise<Array<[number, number]>>;
    getAllPricesWithIds(): Promise<Array<[bigint, [number, number]]>>;
    ...
    getPrice(priceId: bigint): Promise<[number, number] | null>;
    ...
    updateCallerClientInfo(clientInfo: ClientInfo): Promise<void>;
    ...
    updatePrice(priceId: bigint, ratePerTonne: number, ratePerKm: number): Promise<void>;
    updateTransporterDetails(details: TransporterDetails): Promise<void>;
