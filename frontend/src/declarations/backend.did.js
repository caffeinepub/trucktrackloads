...
export const idlService = IDL.Service({
  ...
  'addPrice' : IDL.Func([IDL.Float64, IDL.Float64], [IDL.Nat], []),
  ...
  'deleteContactMessage' : IDL.Func([IDL.Principal], [], []),
  'deleteLoad' : IDL.Func([IDL.Text], [], []),
  'deletePrice' : IDL.Func([IDL.Nat], [], []),
  'deleteTransporter' : IDL.Func([IDL.Principal], [], []),
  ...
  'updateCallerClientInfo' : IDL.Func([ClientInfo], [], []),
  ...
  'updatePrice' : IDL.Func([IDL.Nat, IDL.Float64, IDL.Float64], [], []),
  'updateTransporterDetails' : IDL.Func([TransporterDetails], [], []),
