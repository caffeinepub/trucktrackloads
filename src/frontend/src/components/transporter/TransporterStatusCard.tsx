...
import { useGetCallerTransporterStatus, useSetTransporterStatus } from '@/hooks/useQueries';
import { toast } from 'sonner';

export default function TransporterStatusCard() {
  const { data: currentStatus, isLoading: loadingStatus } = useGetCallerTransporterStatus();
